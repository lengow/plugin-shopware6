import lengowLockableStringField from './components/lgw-lockable-string-field';
import lengowCondionnalStringField from './components/lgw-conditionnal-string-field';
import lengowGeneralSettings from './components/general-settings';
import lengowImportSettings from './components/import-settings';
import lengowExportSettings from './components/export-settings';
import template from './views/lengow-settings.html.twig';
import './views/lengow-settings.scss';
